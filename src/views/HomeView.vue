<template>
    ...
    <div class="row">
      ...
      <div class="col-md-4 m-auto">
        ...
        <div class="row justify-content-center mt-5">
          <RouterLink to="/products" class="btn btn-outline-primary px-5 row justify-content-center" style="width: 200px;">前往探索</RouterLink>
        </div>
      </div>
    </div>
  ...
  <div class="section--about position-relative d-flex align-items-center justify-content-center flex-column" style="min-height: 400px;">
    ...
    <RouterLink to="/about" class="btn btn-outline-primary px-5 row justify-content-center" style="width: 200px; z-index: 2;">關於我們</RouterLink>
  </div>
  <!-- 島嶼風情 -->
  ...
  <swiper-slide v-for="(item) in products" :key="item.id" class="mb-5">
    <RouterLink :to="`/product/${item.id}`">
      <div class="card border-0 mb-4 position-relative p-card">
        ...
        <div class="card-body text-left bg-light bg-md-white">
          <h4>{{ item.title }}</h4>
