<template>
  ...
  <div class="container mt-md-5 mt-3 mb-5">
    <div class="d-flex justify-content-center align-items-center mb-5">
      <h3 class="section-heading">關於島遊</h3>
    </div>
    <div class="row mb-5">
      ...
      <div class="col-md-4 m-auto">
        <p class="text-left mt-4 mt-md-0">島遊是由一群熱愛旅遊，熱愛島嶼的年輕人所組成的新創團隊。
    ...
    <div class="d-flex justify-content-center align-items-center mb-5">
      <h3 class="section-heading">島遊起點</h3>
    </div>
    <div class="row flex-row-reverse justify-content-between my-4">
      ...
      <div class="col-md-4 m-auto">
        <p class="text-right mt-4 mt-md-0">島遊誕生於日本瀨戶內海上的一座小島，豊島。<br>
